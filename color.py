...
def main():
    """
    Scrollbars that allow you to select variable values for image recognition. It is necessary to select such values so that the desired element in the image is as clearly visible as possible in the 'res' or 'mask' window, depending on the selected recognition mode in the main code. To work with an image, place it in the folder with this script and name it 'image.png'.
    """
